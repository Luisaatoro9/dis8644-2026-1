...
En nuestro caso utilizmos los condensdores predetermindos para terminar el circuito los cules funcionaron en el sintetizdor sonando de manera aguda y vibrante en cada uno de sus 4 tiempos, de esto se encargan principalmente los chips y los potenciometros que les daban un tono distinto dependiendo de lo drastico que fuera cambiar el posicion de la perilla, por ejemplo el primer potenciometro marca la velocidad en la que cambia de un sonido a otro o de una luz a otra (la luz y el sonido actuavan a la misma vez dependiendo del Step en el que se encuentre) esto marca la velocidad de cambio, en la parte del sintetizador se encuentran las conexiones de los 4 potenciadores que actuavan directamente con cada uno de los 4 timpos pero de manera individual y solo le cambia el sonido al Step que este asociado, produciendo que cambie su tonalidad al pasar por ese 
